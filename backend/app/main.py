...
from app.api.request_log import router as request_log_router
...
async def lifespan(_app: FastAPI):
    ...
    from app.services.request_log_writer import cleanup_old_request_logs
...
v1.include_router(request_log_router)
